<template>
    ...
    <div class="px-2 mt-5">
        <div class="w-11/12 ml-auto mr-auto mt-2 transform">
            <div class="flex">
                <h4 class="text-2xl text-white mb-2">Reporte de Libro Mayor</h4>
    ...
    methods: {
        goReport() {
            if (this.data.management_date_selected_periods.value != null) {
                window.open(
                    `http://reportes.queeserp.tk/flow.html?_flowId=viewReportFlow&_flowId=viewReportFlow&ParentFolderUri=%2Fthemes%2FReportes&reportUnit=%2Fthemes%2FReportes%2FReportLibroMayor&standAlone=true&companyID=${this.company.id_company}&userID=${this.user.id_user}&periodoID=${this.data.management_date_selected_periods.value}&gestionID=${this.data.management_date_selected.value}&moneyID=${this.data.coin_selected.value}&j_username=jasperadmin&j_password=bitnami&sessionDecorator=no`
                );
            } else {
                window.open(
                    `http://reportes.queeserp.tk/flow.html?_flowId=viewReportFlow&_flowId=viewReportFlow&ParentFolderUri=%2Fthemes%2FReportes&reportUnit=%2Fthemes%2FReportes%2FReportLibroMayor&standAlone=true&companyID=${this.company.id_company}&userID=${this.user.id_user}&periodoID=-1&gestionID=${this.data.management_date_selected.value}&moneyID=${this.data.coin_selected.value}&j_username=jasperadmin&j_password=bitnami&sessionDecorator=no`
                );
            }
        },
    },
